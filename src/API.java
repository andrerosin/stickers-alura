public enum API {
    ...
    LINGUAGENS_PREFERIDAS("http://localhost:8080/linguagens", new ExtratorDeLinguagens()),
    STICKERS("https://alura-languages.fly.dev/linguagens", new ExtratorDeConteudoStickers());
